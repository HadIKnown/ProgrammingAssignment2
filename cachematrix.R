...
## From assignment description: This function creates a special 
...
## From assignment description: This function computes the inverse 
## of the special "matrix" returned by makeCacheMatrix above. If 
